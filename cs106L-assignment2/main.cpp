...
int numCommonLinks(const unordered_set<string>& curr_set, const unordered_set<string>& target_set) {
    auto lambda = [&target_set](auto it)->bool {return target_set.find(it) != target_set.end();};
    return std::count_if(curr_set.begin(), curr_set.end(), lambda);
}
...
vector<string> findWikiLadder(const string& start_page, const string& end_page) {
    ...
    // what parameters it'll take in. Be sure to use the function you implemented in Task 5!
    ...
    auto cmp_fn = [&w, &target_set](const vector<string>& left, const vector<string>& right) {
        ...
        cout << "left: " << page1 << " " << "right: " << page2 << endl;
        return numCommonLinks(w.getLinkSet(page1) ,target_set) < numCommonLinks(w.getLinkSet(page2) ,target_set);
    };
    // END STUDENT CODE HERE
    ///////////////////////////////////////////////////////////////////////////////////////////////////
