...
#include <vector>
#include <algorithm> // 2022.09.04 add by Zijun He for std::move
...
public:
    ...
    */
    ...
    /*
    * 2022.09.04 add by Zijun He
    * For milestone 2: Special Member Functions and Move Semantics
    * Copy Constructor
    * 
    * Usage: HashMap(oldMap) newMap;
    * 
    * Complexity: O(B), B = number of buckets
    */
    ...
    * Move Constructor
    * 
    * Usage: HashMap({1, "this is a string"}) newMap;
    * 
    * Complexity: O(B), B = number of buckets
    */
    ...
    * 
    * Usage: HashMap newMap = HashMap(10);
    * 
    * Complexity: O(B), B = number of buckets
    */
    ...
    * mapped value. This function is also not const-correct, which you will fix in milestone 1.
    */
    M& at(const K& key);

    /*
    * 2022.09.04 add by Zijun He
    * For milestone 1: Const-Correctness
    * This overload is used when the HashMap is const.
    * Returns a r-value copy to the mapped value given a key.
    * If no such element exists, throws exception of type std::out_of_range.
    *
    * Parameters: key of type K.
    * Return value: r-value copy to type V, the mapped value of key.
    *
    * Usage:
    *      cout << cmap.at(3);            // assuming {3, "Avery"} is in the map.
    *      std::string s = cmap.at(3);      // s = "Avery"
    *
    * Exceptions: std::out_of_range if key is not in the map.
    *
    * Complexity: O(1) amortized average case, O(N) worst case, N = number of elements
    ...
    */
     ...
     *      cout << iter->second // print the value
     *
     * Complexity: O(1) amortized average case, O(N) worst case, N = number of elements
     */
